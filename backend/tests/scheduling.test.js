...
output = String(scheduling.calculateOptimalMeetingTime(conflictTimes, preferredTimes, startTime, endTime, 60, 30).toLocaleString("en-US", {timeZone: "America/Los_Angeles"}));
